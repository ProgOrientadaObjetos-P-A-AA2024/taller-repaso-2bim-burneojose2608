...
public class TipoSuv {
    ...
    private double porcetajeAdicional;
    private double seguro;
    private Propietario propietario;

    public TipoSuv(String z, double m, double n, double g, double v, Propietario o) {
        marca = z;
        precioBase = m;
        precioFinal = n;
        porcetajeAdicional = g;
        seguro = v;
        propietario = o;
    ...
    public void establecerPocertajeAdicional(double x) {
        porcetajeAdicional = x;
    }
    ...
    public double obtenerPorentajeAdicional() {
